...
int main() {
	...
	// Check Test 1.3
	if ((testG.coins == G.coins + xtraCoins) && (testG.numBuys == G.numBuys + xtraBuys) && (State == 2)) {
	...
	// Check Test 2.1
	if ((testG.handCount[thisPlayer] == G.handCount[thisPlayer] + newCards) && State == 3) {
	...
	// Check Test 2.2
        if ((testG.deckCount[thisPlayer] == G.deckCount[thisPlayer] - newCards) && State == 4) {
	...
	// Check Test 2.3
	if ((testG.coins == G.coins + xtraCoins) && (testG.numBuys == G.numBuys + xtraBuys) &&(State == 5)) {
	...
	// Check Test 3.3
	if ((testG.coins == G.coins + xtraCoins) && (testG.numBuys == G.numBuys + xtraBuys) && (State == 8)) {
	...
	// Random testing for the amount of newCards the player recieves
        newCards = rand() % 5;
	...
	// Check Test 4.1
	if ((testG.handCount[otherPlayer] == G.handCount[otherPlayer] + newCards) && State == 9) {
	...
	// Check Test 4.2
        if ((testG.deckCount[otherPlayer] == G.deckCount[otherPlayer] - newCards + shuffledCards) && State == 10) {
